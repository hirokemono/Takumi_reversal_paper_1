...
% As a result of (i)--(iii), the energy of the equatorially antisymmetric flow increases. [REPEATED]
...
% + alpha is needed.
{\color{green}
% The present results suggest that intense zonal flow is generated only in the either hemisphere during dipole reversals, and that the flow can start to generate the magnetic field with the opposite polarity from the original magnetic field.
