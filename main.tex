...
\author[Tohoku]{Takumi Kera\corref{cor1}}
...
On the other hand, convective motions in a rotating spherical shell have characteristics that the equatorially symmetric flow is dominant due to the effect of
% {\color{red} 
the Earth's
% } 
rotation. 
% {\color{teal}
To investigate energy transfers between the equatorially symmetric and antisymmetric flows 
% {\color{red} 
in the dipole reversals
% }
, we have performed geodynamo simulations with polarity reversals.
% }
...
% The energy transfer to the equatorially antisymmetric flow is generally small {\color{red} 
comparing with the buoyancy flux to the equatorially symmetric flow.
% }
% {\color{teal}
