...
A difference of the temperature spectrum from the toroidal kinetic energy spectrum is that the equatorially antisymmetric component of the axisymmetric temperature is larger than that of the non-axisymmetric temperature. % , while the non-axisymmetric components of the kinetic energy is larger than the equatorially antisymmetric components of the kinetic energy. 
...
% 以下の意味は合っていますか？ Yeah, That is fine.
{\color{magenta}
